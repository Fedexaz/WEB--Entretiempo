...
<body style="background-color: green;">
	<div class="container-fluid caja-principal" style="overflow-y: scroll; position: fixed; ">
		...
		<h2 class="d-inline text-light" style="background-color: grey;">Tablas y resultados</h2>
		<!-- SECCIÓN UNO -->
			...
			<ul class="navbar-nav mr-auto ml-auto">
				<li class="nav-item">
					<a id="resultadosPop" class="nav-link" href="./resultados.php" data-content="Resultados de todos los partidos." rel="popover" data-placement="top" data-original-title="Resultados" data-trigger="hover">
						<center>
							<i class="fas fa-poll-h icono-activo" style="color:white;"></i>
							<br>
							<span class="texto-icono-activo font-weight-bold text-light">Result.</span>
						</center>
					</a>
				</li>
				<li class="nav-item">
