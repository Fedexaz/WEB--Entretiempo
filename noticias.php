...
<body style="background-color: green;">
	<div class="container-fluid caja-principal" style="overflow-y: scroll; position: fixed; ">
		...
		<h2 class="d-inline text-light" style="background-color: grey;">Noticias</h2>
		<!-- SECCIÓN UNO -->
			...
			<ul class="navbar-nav mr-auto ml-auto">
				...
				<li class="nav-item">
					<a id="fechasPop" class="nav-link" href="./fechas.php" data-content="Fechas de todos los partidos." rel="popover" data-placement="top" data-original-title="Fechas" data-trigger="hover">
						<center>
							<i class="fas fa-clock icono-activo" style="color:white;"></i>
							<br>
							<span class="texto-icono-activo font-weight-bold text-light">Fechas</span>
						</center>
					</a>
				</li>
				<li class="nav-item">
